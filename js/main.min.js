...
$(".submenu__item-show").click(function () {
  ...
  $(this)
    .parent(".submenu__item")
    .parent(".submenu__links")
    .parent(".submenu")
    .addClass("_fixed");
});

$(".submenu__item > .submenu > .submenu__top >._close-submenu").click(
  function () {
    $(this)
      .parent(".submenu__top")
      .parent(".submenu")
...
function Sliders() {
  ...
  $(".mob-slider").each(function (index, el) {
    ...
    SlidersArray[index] = new Swiper(
      `.mob-slider[data-slider-id="${index}"] .swiper-container`,
      {
        slidesPerView: "auto",
        spaceBetween: 0,
        observer: true,
...
$("._show-calc").click(function () {
  ...
  $(this).parents(".product-price__nav").addClass("_active");

  $(".ccalc-minus").click(function () {
    let val = $(this).attr("data-val");
    if (+val < 1) {
      $(this).parents(".catalog-card__nav").removeClass("_active");
      $(this).parents(".product-price__nav").removeClass("_active");
    }
  });
});
...
document.querySelectorAll(".filter-select.color input")?.forEach((input) => {
  input.addEventListener("change", () => {
    if (input.checked) {
      document.querySelector(".filter-select.color .count").innerHTML = "";
      document.querySelector(".filter-select.color .count").style.background =
        input.value;
    }
  });
});
